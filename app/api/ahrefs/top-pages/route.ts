...
import { fetchTopPages, AhrefsKeyMissingError, AhrefsApiError } from '@/lib/ahrefs'
...
export async function GET(req: Request) {
  ...
  try {
    ...
    const data = await fetchTopPages({ supabase, clientId, target, limit, offset, country, forceFresh: fresh })
